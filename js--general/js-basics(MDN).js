...
`const birthday = new Date('May 19 1992');`
...
Math.random()*x
Math.floor(Math.random() * 21) // random 1-20
...
if (x < 10 && y > 1) { /* do something */ } // and
if (x === 5 || y === 5) { /* do something */ } // or
if (!(x === y)) { /* do something */ } // not
...
// search
['a', 'b', 'c'].includes('a') // checks if an array contains specified element.
