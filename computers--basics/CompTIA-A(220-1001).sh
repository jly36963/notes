...
# usb -- universal serial bus (usb a)
# usb c -- 
# ethernet port, network port, LAN port, network connection
    # rj-45
# dvi -- 
# vga -- 
# hdmi -- 
...
# serial port -- 
# analog video connector (s-video)
...
# mirroing -- redundancy. identical data saved to two drives.
