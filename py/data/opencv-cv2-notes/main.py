...
def basic_corner_detection():
    ...
    cv2.imwrite(
        get_output_fp("tree-corners-shi-tomasi-highlighted.jpg"), img_highlighted_st
    )
...
def basic_feature_detection():
    ...
    def fd_orb_harris_corner():
        ...
        cv2.imwrite(
            get_output_fp("tree-feature-detection-orb-harris-corner.jpg"), img_kp
        )
...
def basic_feature_matching():
    ...
    def fm_orb_brute_force():
        ...
        cv2.imwrite(
            get_output_fp("tree-feature-matching-orb-brute-force.jpg"), img_matches
        )
    ...
    def fm_sift_and_knn():
        ...
        cv2.imwrite(
            get_output_fp("tree-feature-matching-sift-and-knn.jpg"), img_matches
        )
    ...
    def fm_orb_brute_force_knn():
        ...
        cv2.imwrite(
            get_output_fp("tree-feature-matching-orb-brute-force-knn.jpg"), img_matches
        )
    ...
    def fm_orb_flann_knn():
        ...
        cv2.imwrite(
            get_output_fp("tree-feature-matching-orb-flann-knn.jpg"), img_matches
        )
    ...
    def fm_akaze_flann_knn():
        ...
        cv2.imwrite(
            get_output_fp("tree-feature-matching-akaze-flann-knn.jpg"), img_matches
        )
    ...
    def fm_akaze_flann_knn_homography():
        ...
        if len(good) > 4:
            ...
            cv2.imwrite(
                get_output_fp("1214-feature-matching-akaze-flann-knn-homography.jpg"),
                img_matches,
            )
...
def basic_upscaling():
    def get_sr() -> "cv2.dnn_superres.DnnSuperResImpl":
