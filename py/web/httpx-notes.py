...
async def requests_get_json(url):
    """
...
async def requests_get_json_with_query(url, params):
    """
...
async def requests_get_json_with_headers(url, headers):
    """
...
async def requests_post_json(url, data):
    """
...
async def main():
    ...
    # get
    requests_get_json_result = await requests_get_json(
        url="https://jsonplaceholder.typicode.com/users/1"
    )

    # get (query)
    requests_get_json_with_query_result = await requests_get_json_with_query(
        url="https://jsonplaceholder.typicode.com/users",
        params={'limit': 5, 'offset': 5}
    )

    # get (headers)
    requests_get_json_with_headers_result = await requests_get_json_with_headers(
        url="https://jsonplaceholder.typicode.com/users/1",
        headers={
    ...
    # post
    requests_post_json_result = await requests_post_json(
        url="https://jsonplaceholder.typicode.com/users",
