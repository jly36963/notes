...
func main() {
	...
	_, err = PostgresDal.AssociateNinjaJutsu(ninjaID, jutsuID)
	if err != nil {
		panic(err)
	}
	...
	ninjaWithJutsu, err := PostgresDal.GetNinjaWithJutsus(ninjaID)
	if err != nil {
		panic(err)
	}
	...
	// delete relation
	_, err = PostgresDal.DissociateNinjaJutsu(ninjaID, jutsuID)
	if err != nil {
		panic(err)
	}
